  ...
  class Renderer {
    constructor(container) {
      ...
      this.init = function (_image, _imageType, _dynamic, haov, vaov, voffset, callback, params) {
        ...
        if (
          params !== undefined$1 &&
          (params.horizonPitch !== undefined$1 || params.horizonRoll !== undefined$1)
        )
          pose = [
       ...
       */
      class MultiresNode {
        constructor(vertices, side, level, x, y, path) {
      ...
      var loadTexture = (function () {
        ...
        class PendingTextureRequest {
          constructor(node, src, texture, callback) {
            this.node = node;
            this.src = src;
            this.texture = texture;
            this.callback = callback;
    ...
    constructor(container, initialConfig) {
      ...
      function onDocumentTouchMove(event) {
        ...
        if (isUserInteracting && loaded) {
          ...
          config.yaw = yaw;
          var pitch =
            (clientY - onPointerDownPointerY) * touchmovePanSpeedCoeff + onPointerDownPitch;
          speed.pitch = (pitch - config.pitch) * 0.2;
          config.pitch = pitch;
        }
      }
        ...
        if (loaded) {
          ...
          if (config.avoidShowingBackground) {
            var hfov2 = config.hfov / 2,
              vfov2 =
                (Math.atan2(Math.tan((hfov2 / 180) * Math.PI), canvas.width / canvas.height) *
                  180) /
                Math.PI,
...
const _addHotSpot = addHotSpot;
export { _addHotSpot as addHotSpot };
const _addScene = addScene;
export { _addScene as addScene };
const _default = ReactPannellum;
export { _default as default };
const _destroy = destroy;
export { _destroy as destroy };
const _getAllScenes = getAllScenes;
export { _getAllScenes as getAllScenes };
const _getConfig = getConfig;
export { _getConfig as getConfig };
const _getContainer = getContainer;
export { _getContainer as getContainer };
const _getCurrentScene = getCurrentScene;
export { _getCurrentScene as getCurrentScene };
const _getHfov = getHfov;
export { _getHfov as getHfov };
const _getHfovBounds = getHfovBounds;
export { _getHfovBounds as getHfovBounds };
const _getHorizonPitch = getHorizonPitch;
export { _getHorizonPitch as getHorizonPitch };
const _getHorizonRoll = getHorizonRoll;
export { _getHorizonRoll as getHorizonRoll };
const _getNorthOffset = getNorthOffset;
export { _getNorthOffset as getNorthOffset };
const _getPitch = getPitch;
export { _getPitch as getPitch };
const _getPitchBounds = getPitchBounds;
export { _getPitchBounds as getPitchBounds };
const _getViewer = getViewer;
export { _getViewer as getViewer };
const _getYaw = getYaw;
export { _getYaw as getYaw };
const _getYawBounds = getYawBounds;
export { _getYawBounds as getYawBounds };
const _isLoaded = isLoaded;
export { _isLoaded as isLoaded };
const _isOrientationActive = isOrientationActive;
export { _isOrientationActive as isOrientationActive };
const _isOrientationSupported = isOrientationSupported;
export { _isOrientationSupported as isOrientationSupported };
const _loadScene = loadScene;
export { _loadScene as loadScene };
const _lookAt = lookAt;
export { _lookAt as lookAt };
const _mouseEventToCoords = mouseEventToCoords;
export { _mouseEventToCoords as mouseEventToCoords };
const _removeHotSpot = removeHotSpot;
export { _removeHotSpot as removeHotSpot };
const _removeScene = removeScene;
export { _removeScene as removeScene };
const _resize = resize;
export { _resize as resize };
const _setHfov = setHfov;
export { _setHfov as setHfov };
const _setHfovBounds = setHfovBounds;
export { _setHfovBounds as setHfovBounds };
const _setHorizonPitch = setHorizonPitch;
export { _setHorizonPitch as setHorizonPitch };
const _setHorizonRoll = setHorizonRoll;
export { _setHorizonRoll as setHorizonRoll };
const _setNorthOffset = setNorthOffset;
export { _setNorthOffset as setNorthOffset };
const _setPitch = setPitch;
export { _setPitch as setPitch };
const _setPitchBounds = setPitchBounds;
export { _setPitchBounds as setPitchBounds };
const _setYaw = setYaw;
export { _setYaw as setYaw };
const _setYawBounds = setYawBounds;
export { _setYawBounds as setYawBounds };
const _startAutoRotate = startAutoRotate;
export { _startAutoRotate as startAutoRotate };
const _startOrientation = startOrientation;
export { _startOrientation as startOrientation };
const _stopAutoRotate = stopAutoRotate;
export { _stopAutoRotate as stopAutoRotate };
const _stopMovement = stopMovement;
export { _stopMovement as stopMovement };
const _stopOrientation = stopOrientation;
export { _stopOrientation as stopOrientation };
const _toggleFullscreen = toggleFullscreen;
export { _toggleFullscreen as toggleFullscreen };
