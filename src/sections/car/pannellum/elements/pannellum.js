...
require("../css/style-textInfo.css");

require("../js/libpannellum.js");

require("../js/pannellum.js");

require("../js/RequestAnimationFrame");
    ...
    (function (_PureComponent) {
      ...
      function Pannellum(props) {
        ...
        _this.renderImage = function (state) {
          ...
          _this.panorama = pannellum.viewer(
            _this.props.id ? _this.props.id : _this.state.id,
            jsonConfig
          );
      ...
      Pannellum.prototype.componentDidUpdate = function componentDidUpdate(
        prevProps,
        prevState,
        snapshot
      ) {
